...
public class InquiryListController {
	...
	public Result<IPage<InquiryList>> queryPageList(InquiryList inquiryList,
		...
		QueryWrapper<InquiryList> queryWrapper = QueryGenerator.initQueryWrapper(inquiryList, req.getParameterMap());
		Page<InquiryList> page = new Page<InquiryList>(pageNo, pageSize);
		IPage<InquiryList> pageList = inquiryListService.page(page, queryWrapper);
...
//		inquiryListService.saveMain(inquiryList, inquiryListPage.getInquiryRecordList(),inquiryListPage.getInquirySupplierList());
...
//		inquiryListService.updateMain(inquiryList, inquiryListPage.getInquiryRecordList(),inquiryListPage.getInquirySupplierList());
...
//          vo.setInquiryRecordList(inquiryRecordList);
...
//                  inquiryListService.saveMain(po, page.getInquiryRecordList(),page.getInquirySupplierList());
              }
