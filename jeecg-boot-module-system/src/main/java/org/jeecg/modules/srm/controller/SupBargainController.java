...
public class SupBargainController extends JeecgController<SupBargain, ISupBargainService> {
	...
	public Result<String> add(@RequestBody SupBargain supBargain) {
		supBargainService.save(supBargain);
	...
	public Result<String> edit(@RequestBody SupBargain supBargain) throws Exception {
		supBargainService.editBargain(supBargain);
