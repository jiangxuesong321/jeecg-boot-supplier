...
public class SupBargain implements Serializable {
    ...
    @Excel(name = "单价-供应商", width = 15)
    @ApiModelProperty(value = "单价-供应商")
    private java.math.BigDecimal suppOrderPriceLocal;
    /**单价-供应商*/
    @Excel(name = "单价-供应商", width = 15)
    @ApiModelProperty(value = "单价-供应商")
    private java.math.BigDecimal suppOrderPriceTaxLocal;
    /**小计-供应商*/
    @Excel(name = "小计-供应商", width = 15)
    @ApiModelProperty(value = "小计-供应商")
    private java.math.BigDecimal suppOrderAmountLocal;
    /**小计-供应商*/
    @Excel(name = "小计-供应商", width = 15)
    @ApiModelProperty(value = "小计-供应商")
    private java.math.BigDecimal suppOrderAmountTaxLocal;
	/**运费-供应商*/
