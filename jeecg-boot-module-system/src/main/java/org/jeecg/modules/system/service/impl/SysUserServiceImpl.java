...
//        SysUser user = userMapper.getUserByName(username);
		SupplierAccount user = iSupplierAccountService.getOne(new LambdaQueryWrapper<SupplierAccount>().
				eq(SupplierAccount::getUsername, username).
				eq(SupplierAccount :: getDelFlag,CommonConstant.DEL_FLAG_0));
        ...
        iSupplierAccountService.update(new SupplierAccount().setPassword(password), new LambdaQueryWrapper<SupplierAccount>().eq(SupplierAccount::getId, user.getId()));
        BasSupplier basSupplier = new BasSupplier();
		basSupplier.setId(user.getSupplierId());
		basSupplier.setSysPwd(newpassword);
		iBasSupplierService.updateById(basSupplier);
